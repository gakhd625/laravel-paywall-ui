...
<div class="paywall-ui-overlay paywall-ui-solid" style="--paywall-opacity: {{ $opacity }};">
    <div class="paywall-ui-backdrop"></div>
    <div class="paywall-ui-content-wrapper">
        <div class="paywall-ui-content-center paywall-ui-card-solid">
